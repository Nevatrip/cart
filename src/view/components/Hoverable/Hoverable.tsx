...
export function withHover<P extends IHoverableComponentProps>(WrappedComponent: any): React.FunctionComponent<P> {
  ...
  const HoverHOC = (props: P) => <HoverableComponent {...props} />;
  return HoverHOC;
};
